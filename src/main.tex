...
\begin{document}
    ...
    \tlcventry[associationcolor]{2013/11}{0}{\fr{Responsable Technique -- Administrateur système}\en{Technical Leader -- System Administrator}}%
    {Junior ISEP}{}{}%
    {
    \begin{junior}
        \begin{multicols}{2}
    ...
    \tlcventry[associationcolor]{2012/10}{0}{ISEPA - \fr{Président Fondateur}\en{Founder and President}}
